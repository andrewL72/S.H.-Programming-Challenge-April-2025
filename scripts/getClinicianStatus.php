<?php
    ...
    //fetch geoJSON data via call to provided API
    $response = exec(escapeshellcmd("curl https://3qbqr98twd.execute-api.us-west-2.amazonaws.com/test/clinicianstatus/1"));

    //parse into object then determine if clinician is outside boundry zone.
    ...
    echo $returnMessage . "<br>\n" . $response . ".........Intersection Count: " . $intersectionCount;
?>